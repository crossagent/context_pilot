...
async def update_strategic_plan(tool_context: ToolContext, plan_content: str):
    """
    Update the Strategic Plan (Query Plan).
    This tool directly updates the plan in the agent's state and persists it as an artifact.
    ...
    try:
        ...
        # We always overwrite the same file to keep a single source of truth for the plan
        ...
        return {
            'status': 'ok',
            'message': 'Strategic plan updated and saved successfully.',
